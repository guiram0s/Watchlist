<?php
	...
	$strSelect="select * from Utilizador";
	...
	function fillTable($numlinhas,$consultaAluno) {
		...
		if($_SESSION["nome"]=="admin"){
			for ($i=0;$i<$numlinhas;$i++){
				...
				echo"<tr>";
                echo "<td>".$linha["idUtilizador"]."</td>";
				echo"<td>".$linha["nome"]."</td>";
				echo"<td>".$linha["email"]."</td>";
				echo"<td>".$linha["password"]."</td>";
                echo"<td>".$linha["recuperacao"]."</td>";
                echo '<td>  <form style="float:left;" method="POST" action=User.php?idUser='.$linha['idUtilizador'].'>
                <button class="btn btn-success" style="margin-left: 5px;" type="submit"><i class="fa fa-gear" style="font-size: 15px;"></i></button>
                </form>
                <form style="float:right;" method="POST" action=InfoPage.php?apagarUser='.$linha['idUtilizador'].'>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Gerir Utilizadores
                        <form style="float:right;" method="POST" action=User.php>
                                ...
                                <div class="table-responsive table table-hover table-bordered results">
                                    <table class="table table-hover table-bordered">
                                        <thead class="bill-header cs">
                                            <tr>
                                                <th id="trs-hd-1" class="col-lg-1" style="background-color: darkgreen;">Id</th>
                                                <th id="trs-hd-2" class="col-lg-2" style="background-color: darkgreen;">Nome</th>
                                                <th id="trs-hd-3" class="col-lg-2" style="background-color: darkgreen;">Email</th>
                                                <th id="trs-hd-3" class="col-lg-1" style="background-color: darkgreen;">Password</th>
                                                <th id="trs-hd-4" class="col-lg-3" style="background-color: darkgreen;">Email Recuperação</th>
                                                <th id="trs-hd-6" class="col-lg-1" style="background-color: darkgreen;">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <?php fillTable($numlinhas,$consultaAluno);?>   
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
