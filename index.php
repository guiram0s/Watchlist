                            ...
                            <div class="col">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-light mb-4">Bem-vindo!</h4>
                                    </div>
                                    <form class="user" action="login.php" method="post">
                                        ...
                                        </div><button class="btn btn-primary d-block btn-user w-100" type="submit" style="background-color: #002d04;border-color: #002d04;">Login</button>
                                        <hr>
                                    </form>
                                </div>
                            </div>
